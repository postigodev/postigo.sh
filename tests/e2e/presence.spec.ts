...
const githubFixture = {
  ...
  login: 'postigodev',
  entries: [
    { id: 'push-1', kind: 'push', phrase: 'pushed to', target: 'postigodev/postigo.sh', detail: 'main branch', url: 'https://github.com/postigodev/postigo.sh/commits/main', createdAt: '2026-08-13T17:52:00.000Z' },
...
test('progressively enhances Spotify and GitHub without blocking static identity', async ({ page }) => {
  ...
  await expect(page.locator('[data-github-widget]')).toContainText('pushed to');
